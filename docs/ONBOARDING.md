...
The `@voltph/shared` package contains Zod schemas and TypeScript interfaces used by both the API and Frontend. If you modify it, remember to run `npm run build` (or `turbo build`) to update the linked `dist` folders.
